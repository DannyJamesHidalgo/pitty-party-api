    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adopter_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pittyapi.adopter')),
                ('dog_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pittyapi.dog')),
            ],
        ),
        migrations.CreateModel(
            name='Adoption',
